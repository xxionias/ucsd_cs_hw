...
top_left_border_loop:
	...
	cmp	r10, ONE	@ loop if outer character is smaller than one
	bge	top_left_border_loop

end_top_left_border_loop:
	mov 	r10, ONE	@ map one to r10
	cmp	r10, r8				
	bgt	end_top_diamond_loop	@ end loop if r10 >= r8
...
end_bottom_diamond_loop:
	mov	r9, HALF_DIVISOR
	sub	r10, r4, r8	@ bottom_right_border_loop if r10>=ONE
	sdiv	r10, r10, r9
	cmp	r10, ONE
...
end_bottom_half_diamond_loop:
	mov	r8, ONE
	cmp	r8, r4		@ end bottom_border_loop if r8 > r4
